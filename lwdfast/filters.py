...
class DigitalFilter:
    ...
    def tofile(self, path='filters'):
        ...
        >>> import lwdfast
        >>> # Load a filter
        >>> filt = lwdfast.filters.Hankel().wer_201_2018
    ...
    def fromfile(self, path='filters'):
        ...
        >>> filt = lwdfast.filters.DigitalFilter('my-filter')
...
class Hankel(_BaseFilter):
    ...
    .. ipython::
       ...
       In [1]: import lwdfast
          ...: dlf = lwdfast.filters.Hankel().wer_201_2018

       In [2]: H = lwdfast.filters.Hankel()
          ...: H.wer_201_2018.name
       Out[2]: 'wer_201_2018'
...
class Fourier(_BaseFilter):
    ...
    .. ipython::
       ...
       In [1]: import lwdfast
          ...: dlf = lwdfast.filters.Fourier().key_201_2012

       In [2]: F = lwdfast.filters.Fourier()
          ...: F.key_201_2012.name
       Out[2]: 'key_201_2012'
...
def _deprecate_filter(func):
    ...
    def newfn():
        ...
        # Throw warning.
        msg = (
            f"Calling `lwdfast.filters.{name}()` is deprecated and will be "
            f"removed in v3.0; use `lwdfast.filters.{ftype}().{new}`."
        )
