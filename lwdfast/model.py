...
straight the :mod:`lwdfast.kernel`. The :func:`gpr`-routine convolves the
...
from lwdfast import kernel, transform
from lwdfast.utils import (
...
def bipole(src, rec, depth, res, freqtime, signal=None, aniso=None,
    ...
    src, rec : list of floats or arrays
        ...
        - azimuth (掳): horizontal deviation from x-axis, anti-clockwise.
        - +/-dip (掳): vertical deviation from xy-plane down/up-wards.
    ...
    res : array_like
        ...
        Alternatively, res can be a dictionary. See the main manual of lwdfast
    ...
    msrc, mrec : bool or string, default: False
        ...
        density is proportional to the electric field, J=蟽E). Only implemented
    ...
    htarg : dict, optional
        ...
        - If `ht='dlf'`:
          ...
          - `dlf`: string of filter name in :mod:`lwdfast.filters` or the
            filter method itself. (default:
            ``lwdfast.filters.Hankel().key_201_2009``)
    ...
    ftarg : dict, optional
        ...
        - If `ft='dlf'`, 'sin', or 'cos':
          ...
          - `dlf`: string of filter name in :mod:`lwdfast.filters` or the
            filter method itself. (Default:
            ``lwdfast.filters.Fourier().key_201_2012``)
    ...
    .. ipython::
       ...
       In [1]: import lwdfast
          ...
          ...: EMfield = lwdfast.bipole(src, rec, depth, res, freq, verb=3)
       Out[1]:
          ...: :: lwdfast START  ::  v2.0.0
          ...:
          ...
          ...:    Required ab's   :  11
          ...:
          ...: :: lwdfast END; runtime = 0:00:00.005536 :: 1 kernel call(s)
...
def loop(src, rec, depth, res, freqtime, signal=None, aniso=None, epermH=None,
    ...
    .. ipython::
       ...
       In [1]: import lwdfast
          ...
          ...: # [mrec = True (default)]
          ...: EMfield = lwdfast.loop(src, rec, depth, res, freq, verb=3)
       Out[1]:
          ...: :: lwdfast START  ::  w2.0.0
          ...:    depth       [m] :  0 300 500
          ...
          ...:    Required ab's   :  33
          ...:
          ...: :: lwdfast END; runtime = 0:00:00.005025 :: 1 kernel call(s)
...
from lwdfast._magnetic import magnetic_dipole
...
def analytical(src, rec, res, freqtime, solution='fs', signal=None, ab=11,
    ...
    You can call the functions :func:`lwdfast.kernel.fullspace` and
    :func:`lwdfast.kernel.halfspace` in :mod:`lwdfast.kernel` directly. This
    ...
    .. ipython::
       ...
       In [1]: import lwdfast
          ...
          ...: rec = [np.arange(1, 11)*500, np.zeros(10), 200]
          ...: res = 50
          ...: EMfield = lwdfast.analytical(src, rec, res, freqtime=1, verb=0)
          ...: EMfield[0]
...
def fem(ab, off, angle, zsrc, zrec, lsrc, lrec, depth, freq, etaH, etaV, zetaH,
    ...
    :mod:`lwdfast.model`. Consult those for more details regarding the input
